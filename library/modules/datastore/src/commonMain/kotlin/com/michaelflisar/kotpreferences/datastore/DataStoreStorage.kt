...
class DataStoreStorage internal constructor(
    ...
    override fun getIntSet(key: String, defaultValue: Set<Int>) =
        get2(
            ...
            defaultValue,
            StorageEncryption::decryptIntSet,
            SetConverter::convertStringToIntSet
        )
    ...
    override suspend fun setIntSet(key: String, value: Set<Int>) =
        set2(
            ...
            ::stringSetPreferencesKey,
            value,
            StorageEncryption::encryptIntSet,
            SetConverter::convertIntSetToStringSet
        )
    ...
    override fun getLongSet(key: String, defaultValue: Set<Long>) =
        get2(
            ...
            ::stringSetPreferencesKey,
            defaultValue,
            StorageEncryption::decryptLongSet,
            SetConverter::convertStringToLongSet
        )
    ...
    override suspend fun setLongSet(key: String, value: Set<Long>) =
        set2(
            ...
            ::stringSetPreferencesKey,
            value,
            StorageEncryption::encryptLongSet,
            SetConverter::convertLongSetToStringSet
        )
    ...
    override fun getFloatSet(key: String, defaultValue: Set<Float>) =
        get2(
            ...
            ::stringSetPreferencesKey,
            defaultValue,
            StorageEncryption::decryptFloatSet,
            SetConverter::convertStringToFloatSet
        )
    ...
    override suspend fun setFloatSet(key: String, value: Set<Float>) =
        set2(
            ...
            ::stringSetPreferencesKey,
            value,
            StorageEncryption::encryptFloatSet,
            SetConverter::convertFloatSetToStringSet
        )
    ...
    override fun getDoubleSet(key: String, defaultValue: Set<Double>) =
        get2(
            ...
            ::stringSetPreferencesKey,
            defaultValue,
            StorageEncryption::decryptDoubleSet,
            SetConverter::convertStringToDoubleSet
        )
    ...
    override suspend fun setDoubleSet(key: String, value: Set<Double>) =
        set2(
            ...
            ::stringSetPreferencesKey,
            value,
            StorageEncryption::encryptDoubleSet,
            SetConverter::convertDoubleSetToStringSet
        )
}